...
struct LearnGridView: View {
        ...
        var learnTasks: [DailyTask] {
            taskListModel.dailyTasks.filter { $0.type == .learn }
        }
    ...
    #Preview {
        LearnGridView(taskListModel: TaskListModel.shared, onTaskDelete: { task in TaskListModel.shared.deleteTask(task) })
    }
