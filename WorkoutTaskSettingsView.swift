...
struct WorkoutTasksSettingsView: View {
    ...
    var filteredApps: [TaskApplication] {
            ApplicationData.appList.filter { app in
                app.availableTasks.contains { $0.type == .workout }
            }
        }
        ...
        VStack {
            ...
            VStack(alignment: .leading) {
                ...
                if let app = selectedApp {
                    Picker("Select Task", selection: $selectedTaskOption) {
                        ForEach(app.availableTasks.filter { $0.type == .workout }, id: \.name) { task in
            ...
            Button("Save") {
                ...
                let newTask = DailyTask(
                    ...
                    type: .workout, // Change this if needed for different task types
...
struct WorkoutTasksSettingsView_Previews: PreviewProvider {
    @State static var isPresented = true

    static var previews: some View {
        WorkoutTasksSettingsView(
