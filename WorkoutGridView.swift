...
struct WorkoutGridView: View {
            ...
            var workoutTasks: [DailyTask] {
                taskListModel.dailyTasks.filter { $0.type == .workout }
            }
    ...
    var body: some View {
        ...
        #Preview {
            WorkoutGridView(taskListModel: TaskListModel.shared, onTaskDelete: { task in TaskListModel.shared.deleteTask(task) })
        }
