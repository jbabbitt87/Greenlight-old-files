//
//  ExerciseTasksSettingsView.swift
//  GreenLightV4
//
...
struct ExerciseTasksSettingsView: View {
    ...
    var filteredApps: [TaskApplication] {
        ApplicationData.appList.filter { app in
            app.availableTasks.contains { $0.type == .exercise }
        }
    }
        ...
        VStack {
            ...
            VStack(alignment: .leading) {
                ...
                if let app = selectedApp {
                    Picker("Select Task", selection: $selectedTaskOption) {
                        ForEach(app.availableTasks.filter { $0.type == .exercise }, id: \.name) { task in
            ...
            Button("Save") {
                ...
                let newTask = DailyTask(
                    ...
                    type: .exercise, // Change this if needed for different task types
...
struct ExerciseTasksSettingsView_Previews: PreviewProvider {
    @State static var isPresented = true

    static var previews: some View {
        ExerciseTasksSettingsView(
